...
//       </div>
//       <h1 className="text-2xl font-bold text-primary mt-4">Order Confirmed!</h1>
...
//         <div>
//           <h3 className="text-sm font-medium text-primary/60">Order Number</h3>
//           <p className="mt-1 text-sm text-primary">{data.orderNumber}</p>
//         </div>
//         <div>
//           <h3 className="text-sm font-medium text-primary/60">Date</h3>
//           <p className="mt-1 text-sm text-primary">{data.orderDate}</p>
//         </div>
//         <div>
//           <h3 className="text-sm font-medium text-primary/60">Total</h3>
//           <p className="mt-1 text-sm text-primary">${data.total.toFixed(2)}</p>
//         </div>
//         <div>
//           <h3 className="text-sm font-medium text-primary/60">
//             Estimated Delivery
//           </h3>
//           <p className="mt-1 text-sm text-primary">{data.estimatedDelivery}</p>
//         </div>
//       </div>
//     </div>
